    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $products = $query->select(
                ...
                DB::raw('MIN(v.sell_price_inc_tax - v.dpp_inc_tax) as win_price_min'),
                DB::raw('MAX(v.sell_price_inc_tax - v.dpp_inc_tax) as win_price_max')
                )->groupBy('products.id');
            ...
            return Datatables::of($products)
                ...
                ->addColumn(
                    'win_price',
                    '<div style="white-space: nowrap;"><span class="display_currency" data-currency_symbol="true">{{$win_price_min}}</span> @if($max_price != $min_price && $type == "variable") -  <span class="display_currency" data-currency_symbol="true">{{$win_price_max}}</span>@endif </div>'
                )
                ...
                ->rawColumns(['action', 'image', 'mass_delete', 'product', 'selling_price', 'win_price', 'purchase_price', 'category'])
                ->make(true);
        }
