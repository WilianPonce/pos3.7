                ...
                ->addColumn(
                    ...
                    function ($row) use ($only_shipments) {
                        ...
                        if (!$only_shipments) {
                            ...
                            $html .= '<li><a href="javascript:void(0)" data-toggle="modal" id="modalclicksell" data-id="'.$row->id.'" data-target="#modalcorreosell"><i class="fas fa-file-pdf"></i> Enviar a correo</a></li>';
                        }
