...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/sells/enviocorreosell', 'SellPosController@enviopdfsell');
    Route::post('/sells/enviocorreopurchase', 'PurchaseController@enviopdfpurchase');
    Route::get('/sells/obtenercorreo/{id}', 'PurchaseController@obtenercorreo');

    Route::get('/sells/ejemplo', 'PurchaseController@correo');
    ...
    //envio de facturas SSI
    Route::put('/sells/pos/factura/ssi/{id}', 'SellPosController@envio_ssi');
    Route::get('/pos/{id}/sii_documents', 'SellPosController@documents_ssi');
