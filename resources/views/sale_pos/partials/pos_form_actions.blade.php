...
<div class="row">
	<div class="pos-form-actions">
		<div class="col-md-12">
			...
			<!--Formato envio SII-->
			@if(!empty($edit))
				<button type="button" class="btn btn-secondary btn-flat no-print facturacion_sii" data-pay_method="cash" title="Factuación al SII"> 
					<i class="fas fa-file-code" aria-hidden="true"></i> Facturación
				</button>
				<!--<button type="button" class="btn btn-info btn-flat no-print guia_sii" title="Guia de remisión al SII"> 
					<i class="fas fa-dolly" aria-hidden="true"></i> Guia
				</button>-->
			@endif
