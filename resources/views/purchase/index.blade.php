...
<section class="content no-print">
    ...
    <div class="modal fade" id="modalcorreopurchase" tabindex="-1" aria-labelledby="modalcorreopurchase" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" style="display: inline;">Agregar los correos a enviar</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <input type="hidden" id="campoidpurchase">
                    <div id="correostotalespurchase" class="hidden"></div>
                    <div id="campovariospurchase" class="mb-3"></div>
                    <input type="email" id="correosvariospurchase" class="form-control" placeholder="agrega el correo a enviar...">
                    <span style="font-size: 11px;">Debe presionar la tecla enter para agragar el correo</span>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" id="cerrarmodalpurchase" data-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary" id="enviocorreopurchase">Enviar</button>
                </div>
            </div>
        </div>
    </div>
