...
<div class="modal-header">
    <h4 class="modal-title" id="modalTitle" style="font-weight: 200"> @lang('purchase.purchase_details') (<b>@lang('purchase.ref_no'):</b> #{{ $purchase->ref_no }})</h4>
    <hr>
</div>
<div class="modal-body">
  <div class="row">
    <div class="col-sm-12">
      <p class="pull-right" style="text-align: right"><b>@lang('messages.date'):</b> {{ @format_date($purchase->transaction_date) }}</p>
    </div>
  </div>
  <div class="row invoice-info" style="display:flex;margin-bottom:-100px">
    <div style="width: 33%;">
    ...
    <div style="top:0;margin-left:66%;width: 33%">
        ...
        <table class="table bg-gray" style="width: 100%">
          <thead>
            <tr class="bg-green">
              ...
              <th style="border-bottom: 1px solid #ddd">@lang('product.product_name')</th>
              <th style="border-bottom: 1px solid #ddd" class="text-right">@lang('purchase.purchase_quantity')</th>
              <th style="border-bottom: 1px solid #ddd" class="text-right">@lang( 'lang_v1.unit_cost_before_discount' )</th>
              <th style="border-bottom: 1px solid #ddd" class="text-right">@lang( 'lang_v1.discount_percent' )</th>
              <th style="border-bottom: 1px solid #ddd" class="no-print text-right">@lang('purchase.unit_cost_before_tax')</th>
              <th style="border-bottom: 1px solid #ddd" class="no-print text-right">@lang('purchase.subtotal_before_tax')</th>
              <th style="border-bottom: 1px solid #ddd" class="text-right">@lang('sale.tax')</th>
              <th style="border-bottom: 1px solid #ddd" class="text-right">@lang('purchase.unit_cost_after_tax')</th>
              <th style="border-bottom: 1px solid #ddd" class="text-right">@lang('purchase.unit_selling_price')</th>
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-sm-12 col-xs-12">  
      <div class="table-responsive">
        <table class="table tableu" style="width: 100%;">
          <!-- <tr class="hide">
          ...
          <tr>
            <th style="text-align:left;">@lang('purchase.net_total_amount'): </th>
            <td style="text.align:center"></td>
            <td style="text-align:right"><span class="display_currency pull-right" data-currency_symbol="true">{{ $total_before_tax }}</span></td>
          </tr>
          <tr>
            <th style="text-align:left;">@lang('purchase.discount'):</th>
          ...
          <tr>
            <th style="text-align:left;">@lang('purchase.purchase_tax'):</th>
          ...
          @if( !empty( $purchase->shipping_charges ) )
            <tr>
              <th style="text-align:left;">@lang('purchase.additional_shipping_charges'):</th>
              <td style="text.align:center"><b>(+)</b></td>
              <td style="text-align:right"><span class="display_currency pull-right" >{{ $purchase->shipping_charges }}</span></td>
            </tr>
          @endif
          <tr>
            <th style="text-align:left;">@lang('purchase.purchase_total'):</th>
            <td style="text.align:center"></td>
            <td style="text-align:right"><span class="display_currency pull-right" data-currency_symbol="true" >{{ $purchase->final_total }}</span></td>
          </tr>
        </table>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <p class="well well-sm no-shadow bg-gray" style="border: 1px solid #ddd; padding: 7px;">
  ...
  <div class="row print_section">
    <div class="col-xs-12" style="text-align: center">
      <img class="center-block" style="text-align: center" src="data:image/png;base64,{{DNS1D::getBarcodePNG($purchase->ref_no, 'C128', 2,30,array(39, 48, 54), true)}}">
    </div>
  </div>
</div>