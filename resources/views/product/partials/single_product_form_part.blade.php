...
<div class="table-responsive">
    <table class="table table-bordered add-product-price-table table-condensed {{$class}}">
        <tr>
          <th style="background-color: #1ec569;color: rgb(0,0,0,.8);">@lang('product.default_purchase_price')</th>
          <th style="background-color: #1ec569;color: rgb(0,0,0,.8);">@lang('product.profit_percent') @show_tooltip(__('tooltip.profit_percent'))</th>
          <th style="background-color: #1ec569;color: rgb(0,0,0,.8);">@lang('product.default_selling_price')</th>
          <th style="background-color: #1ec569;color: rgb(0,0,0,.8);">Ganancia</th>
          @if(empty($quick_add))
            <th style="background-color: #1ec569;color: rgb(0,0,0,.8);">@lang('lang_v1.product_image')</th>
          @endif
        </tr>
        <tr>
          <td>
          ...
          <td>
            <span id="ganancia" style="margin-top: 28px;text-align: center;display: block;">$ 0</span>
          </td>
          @if(empty($quick_add))
          <td>
