...
<div class="modal fade" id="modalcorreosell" tabindex="-1" aria-labelledby="modalcorreosell" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="campoidsell">
                <div id="correostotales" class="hidden"></div>
                <div id="campovariossell" class="mb-3"></div>
                <input type="email" id="correosvariossell" class="form-control" placeholder="agrega el correo a enviar...">
                <span style="font-size: 11px;">Debe presionar la tecla enter para agragar el correo</span>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="cerrarmodalsell" data-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-primary" id="enviocorreosell">Enviar</button>
            </div>
        </div>
    </div>
</div>
